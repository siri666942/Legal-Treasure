...
Page({
  ...
  viewCaseDetail(e) {
    ...
    if (caseItem) {
      wx.navigateTo({
        url: `/subpackages/client/pages/case-search-detail/case-search-detail?id=${caseId}&title=${encodeURIComponent(caseItem.title)}&history=true`
      });
    }
  },
  ...
  viewCaseDocuments(e) {
    ...
    if (caseItem) {
      ...
      setTimeout(() => {
        wx.navigateTo({
          url: `/subpackages/client/pages/case-documents/case-documents?caseId=${caseId}&title=${encodeURIComponent(caseItem.title)}`
        });
      }, 500);
    }
  },
  ...
  contactClient(e) {
    ...
    if (caseItem) {
      wx.navigateTo({
        url: `/subpackages/client/pages/chat/index?caseId=${caseId}&client=${caseItem.client}`
      });
    }
  }
});